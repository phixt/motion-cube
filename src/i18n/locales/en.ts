...
export const en: Record<string, string> = {
  ...
  "hand.viewZoom": "Right-hand interactive view",
  "hand.viewStatic": "Static",
  "hand.viewDynamic": "Dynamic",
  "hand.viewZoomHint": "Dynamic: drag to rotate, wheel to zoom",
  "hand.ruler": "Ruler",
  ...
  "hand.thumb": "Thumb (CMC rest pose / thenar, in cubie edges / degrees)",
  "hand.cmcAbduction": "Splay",
  "hand.cmcElevation": "Lift",
  "hand.cmcRotation": "Oppose",
  "hand.cmcHint": "Splay = away from the index within the palm plane; Lift = raise off the palm toward the nail side; Oppose = roll about the thumb's long axis (pad facing).",
  "hand.thenar": "Thenar",
  "hand.thenarWidth": "Width",
  ...
  "hand.shapeWeb": "Webbing",
  "hand.shapeJitter": "Facet jitter",
  ...
  "solve.opt.zbllHint": "Advanced LL in one step — data coverage incomplete, entry point only",
  "solve.opt.rouxEolr": "EOLR (EO + UL/UR together)",
  "solve.opt.rouxEolrHint": "Roux advanced research in progress",
  "solve.opt.rouxMerge": "Merge 4b+4c (one-step LSE)",
  "solve.opt.rouxMergeHint": "LSE as a single phase — opposite of stepwise human-style demo",

  // Keymap page
  "keymap.title": "Settings",
  "keymap.presetBeginner": "Beginner (arrow keys)",
  "keymap.presetDefault": "Default (move notation)",
  ...
  "keymap.editor.bothHands": "Toggle both hands",
  ...
  "editor.frame": "Frame",
  "editor.editHand": "Edit hand",
  "editor.handMain": "Main",
  "editor.handMirror": "Mirror",
  "editor.mirrorFollow": "Mirroring main hand",
  "editor.clearMirror": "Clear mirror data",
  ...
  "editor.posRy": "RY",
  "editor.posRz": "RZ",
  "editor.thumbCmc": "Thumb CMC (°): splay / lift / oppose",
