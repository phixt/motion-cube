...
export const zhCN: Record<string, string> = {
  ...
  "hand.viewZoom": "右手交互视图",
  "hand.viewStatic": "静态",
  "hand.viewDynamic": "动态",
  "hand.viewZoomHint": "动态：拖拽旋转 + 滚轮缩放",
  "hand.ruler": "标尺",
  ...
  "hand.thumb": "拇指（CMC 外翻 / 大鱼际，单位：块边长 / 度）",
  "hand.cmcAbduction": "展收",
  "hand.cmcElevation": "抬离",
  "hand.cmcRotation": "对掌",
  "hand.cmcHint": "展收 = 掌平面内离开食指方向；抬离 = 向指背侧抬起离开掌面；对掌 = 绕拇指长轴自转（改变指腹朝向）",
  "hand.thenar": "大鱼际",
  "hand.thenarWidth": "宽",
  "hand.thenarHeight": "厚",
  "hand.thenarLength": "长",
  ...
  "solve.opt.zbllHint": "高级 LL 一步完成；数据覆盖未完善，先留入口",
  "solve.opt.rouxEolr": "EOLR（EO+UL/UR 一步）",
  "solve.opt.rouxEolrHint": "Roux 高级调研进行中",
  "solve.opt.rouxMerge": "合并 4b+4c（LSE 一步）",
  "solve.opt.rouxMergeHint": "LSE 整段一步，非人类式分步演示",
  ...
  "editor.editHand": "编辑手",
  "editor.handMain": "主手",
  "editor.handMirror": "对侧手",
  "editor.mirrorFollow": "镜像跟随主手",
  "editor.clearMirror": "清除对侧数据",
  ...
  "editor.posRy": "RY",
  "editor.posRz": "RZ",
  "editor.thumbCmc": "拇指 CMC（°）：展收 / 抬离 / 对掌",
  "editor.snapOn": "吸附 开",
  "editor.snapOff": "吸附 关",
  "editor.posX": "X",
  "editor.posY": "Y",
